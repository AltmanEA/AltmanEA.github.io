...
При письменном ответе на вопрос в кадре пол экрана занимает изображение рабочего стола, вторую половину - изображение с камеры. На рабочем столе должны быть открыты только программы для организации трансляции, работы с почтой и чата в портале ОмГУПС (нужно закрыть лишние вкладки в браузере).

...
Выполнение практического задание требует определенного времени, поэтому, для сокращения времени проведения аттестации (защиты) практические задания могут выдаваться одновременно нескольким студентам. Видеотрансляция в этом случае должна быть организована индивидуально для каждого студента самим студентом.
...
Для трансляции YouTube нужно создать свою учетную запись.
...
На сайте YouTube в личном кабинете можно скачать файл с трансляцией. Рекомендуется сжать этот файл (например, программой ffmpeg) и сохранить.
